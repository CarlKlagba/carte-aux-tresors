...
public class AventurierTest extends AbstractTest{
	...
	public void GivenNord_WhenDroite_ThenEst(){
		...
		Aventurier aventurier = new Aventurier("John",1,1, Orientation.NORD,null);
	...
	public void Given11AndSud_WhenAvance_Then12(){
		...
		Aventurier aventurier = new Aventurier("John",1,1, Orientation.SUD,null);
		aventurier.avance();
		assertEquals(expectedPosX, aventurier.getPositionX());
		assertEquals(expectedPosY, aventurier.getPositionY());		
	}
	...
	public void Given21AndOuest_WhenAvance_Then11(){
		...
		Aventurier aventurier = new Aventurier("John",2,1, Orientation.OUEST,null);
		aventurier.avance();
		assertEquals(expectedPosX, aventurier.getPositionX());
		assertEquals(expectedPosY, aventurier.getPositionY());		
	}
	...
	public void Given12AndNord_WhenAvance_Then11(){
		...
		Aventurier aventurier = new Aventurier("John",1,2, Orientation.NORD,null);
		aventurier.avance();
		assertEquals(expectedPosX, aventurier.getPositionX());
		assertEquals(expectedPosY, aventurier.getPositionY());		
	}
